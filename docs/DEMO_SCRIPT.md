...
> "The infrastructure cost is zero. Claude tokens are the only marginal cost — about $0.10–$0.30 per run."
...
Infrastructure: $0/month (Supabase Free + Vercel Hobby). Claude API: ~$0.10–$0.30 per run. At 20 runs/month: ~$2–6 in tokens.
